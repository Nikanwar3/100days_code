...
public class AdvancedBinarySearch {
    ...
    /**
     * Generic binary search with a custom Comparator
     */
    ...
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            ...
            int index = binarySearch(
                    students,
                    new Student(id, ""), // dummy for comparison
                    Comparator.comparingInt(s -> ((Student) s).id)
            );
            ...
            System.out.print("Enter Name to search (case-sensitive): ");
            ...
            int index = binarySearch(
                    students,
                    new Student(0, name),
                    Comparator.comparing(s -> ((Student) s).name)
            );
